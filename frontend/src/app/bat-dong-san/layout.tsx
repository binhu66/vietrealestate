...
export const metadata: Metadata = {
  title: "Mua bán bất động sản | VietRealty",
  description: "Hàng nghìn tin mua bán nhà đất, căn hộ chung cư, biệt thự, đất nền trên toàn quốc. Tìm ngôi nhà mơ ước với VietRealty.",
