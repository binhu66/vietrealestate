    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-white">VietRealty</h1>
          <p className="text-gray-400 mt-1">{t.admin.login}</p>
        </div>

        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-8">
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              <label className="text-sm text-gray-400 mb-2 block">{t.admin.email}</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="text-sm text-gray-400 mb-2 block">{t.admin.password}</label>
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 pr-12 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 p-4 bg-gray-800/50 rounded-xl text-xs text-gray-500 space-y-1">
