    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-12">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-black text-gray-900 mb-2">Đăng tin bất động sản</h1>
          <p className="text-gray-500">Chọn loại bất động sản bạn muốn đăng</p>
        </div>
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="text-center">
              <div className="font-bold text-gray-900 text-lg">Nhà ở dân dụng</div>
              <div className="text-sm text-gray-500 mt-1">Căn hộ, nhà riêng, biệt thự, đất nền</div>
            </div>
          ...
          >
            ...
            <div className="text-center">
              <div className="font-bold text-gray-900 text-lg">Thương mại</div>
              <div className="text-sm text-gray-500 mt-1">Văn phòng, mặt bằng, kho xưởng, khách sạn</div>
            </div>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        <button onClick={() => setStep("type")} className="text-sm text-gray-500 hover:text-gray-700">← Quay lại</button>
        ...
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold ${isCommercial ? "bg-amber-100 text-amber-700" : "bg-red-100 text-red-700"}`}>
          ...
          {isCommercial ? "Thương mại" : "Nhà ở dân dụng"}
        </div>
      </div>

      <h1 className="text-2xl font-black text-gray-900 mb-6">Thông tin bất động sản</h1>
