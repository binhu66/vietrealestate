...
export const metadata: Metadata = {
  title: "Điều khoản sử dụng | VietRealty",
  description: "Điều khoản và điều kiện sử dụng dịch vụ VietRealty - Sàn giao dịch bất động sản hàng đầu Việt Nam.",
};
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 text-gray-600 leading-relaxed">
        <section>
          ...
          <p>Bằng cách truy cập và sử dụng VietRealty, bạn đồng ý bị ràng buộc bởi các điều khoản và điều kiện này. Nếu bạn không đồng ý, vui lòng không sử dụng dịch vụ của chúng tôi.</p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>VietRealty có quyền xóa bất kỳ tin đăng nào vi phạm quy định.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>VietRealty là nền tảng kết nối và không chịu trách nhiệm về tính xác thực của thông tin do người dùng cung cấp. Mọi giao dịch bất động sản cần được thực hiện theo đúng quy định pháp luật Việt Nam.</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-2">5. Quyền sở hữu trí tuệ</h2>
          <p>Toàn bộ nội dung, thiết kế và tính năng của VietRealty được bảo vệ bởi quyền sở hữu trí tuệ. Nghiêm cấm sao chép, phân phối mà không có sự đồng ý bằng văn bản.</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-2">6. Thay đổi điều khoản</h2>
          <p>VietRealty có quyền cập nhật điều khoản này bất cứ lúc nào. Người dùng sẽ được thông báo về các thay đổi quan trọng qua email đã đăng ký.</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-2">7. Liên hệ</h2>
          <p>Mọi thắc mắc về điều khoản sử dụng, vui lòng liên hệ: <a href="mailto:info@vietrealty.vn" className="text-red-600 hover:underline">info@vietrealty.vn</a></p>
        </section>
      </div>
    </div>
  );
