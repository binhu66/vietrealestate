...
export const metadata: Metadata = {
  title: "Bất động sản thương mại | BinHorizon",
  description: "Tìm văn phòng cho thuê, mặt bằng kinh doanh, kho xưởng, khách sạn trên toàn quốc. Bất động sản thương mại uy tín tại BinHorizon.",
