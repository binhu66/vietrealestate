...
export const metadata: Metadata = {
  title: "Cho thuê bất động sản | VietRealty",
  description: "Tìm nhà cho thuê, căn hộ cho thuê, văn phòng cho thuê, mặt bằng kinh doanh trên toàn quốc. Hàng nghìn tin cho thuê uy tín tại VietRealty.",
