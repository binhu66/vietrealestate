...
export const metadata: Metadata = {
  title: "Giới thiệu | BinHorizon",
  description: "BinHorizon - Sàn giao dịch bất động sản hàng đầu Việt Nam, kết nối người mua, người bán và môi giới bất động sản trên toàn quốc.",
};

export default function GioiThieuPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-black text-gray-900 mb-3">Giới thiệu về BinHorizon</h1>
      ...
      <div className="prose prose-gray max-w-none space-y-8">
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            BinHorizon được thành lập với sứ mệnh đơn giản nhưng mạnh mẽ: giúp mọi người Việt Nam dễ dàng tìm được ngôi nhà mơ ước của mình.
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3">Tại sao chọn BinHorizon?</h2>
        ...
        <section>
          ...
          <div className="bg-red-50 rounded-xl p-5 border border-red-100">
            ...
            <p className="text-gray-700 mb-1">✉️ Email: <a href="mailto:info@binhorizon.com" className="text-red-600 hover:underline">info@binhorizon.com</a></p>
