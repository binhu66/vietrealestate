  ...
  return (
    <div className="space-y-3">
      {step === "phone" ? (
        <>
          <div className="flex gap-2">
            ...
            <input
              ...
              placeholder="901 234 567" maxLength={12}
        ...
        <>
          <p className="text-xs text-gray-500">Nhập mã OTP đã gửi đến <strong>{phone}</strong></p>
          <input
          ...
          <button onClick={() => setStep("phone")} className="w-full text-xs text-gray-400 hover:text-gray-600">← Đổi số điện thoại</button>
        </>
      )}
